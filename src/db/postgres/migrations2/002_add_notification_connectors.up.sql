...
-- ----------------------------------------------------------------------------
-- 3) connector_configs — organization-scoped connector configurations
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 4) connector_secrets — OAuth tokens, refresh tokens, rotating secrets
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 6) notification_routes — routing rules
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 7) notification_deliveries — delivery attempt log
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 8) notification_dead_letter — unrecoverable failures
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 9) connector_health_checks — heartbeat history
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 10) connector_audit_logs — connector-scoped audit trail
-- ----------------------------------------------------------------------------
