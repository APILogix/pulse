-- ============================================================================
-- 010_add_ingestion_usage_counters.up.sql
-- ----------------------------------------------------------------------------
...
--   Tier 2: usage_counter_staging — UNLOGGED table. No WAL, so bulk inserts
...
--   Tier 3: project_usage — durable, logged, hourly-bucketed rollups. This is
...
-- ----------------------------------------------------------------------------
-- 1) TIER 2 — UNLOGGED staging table (fast writes, no WAL).
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 2) TIER 3 — durable hourly-bucketed rollups.
-- ----------------------------------------------------------------------------
...
-- ============================================================================
-- 3) flush_usage_counters() — staging -> hourly buckets (UPSERT) -> delete.
-- ----------------------------------------------------------------------------
...
-- ============================================================================
-- 4) project_usage_realtime — durable buckets + un-flushed staging.
-- ============================================================================
BEGIN;
