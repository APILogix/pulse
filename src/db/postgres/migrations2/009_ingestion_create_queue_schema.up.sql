...
--   * ingestion_jobs            â€” correlation columns (event_id, trace_id,
--                                 span_id, session_id, user_id, tenant_id),
--                                 generated priority_label, error_code,
--                                 processed_by, processing_duration_ms.
--   * ingestion_dead_letter_jobsâ€” error_code, max_attempts, replayed_by,
--                                 created_at (full lifecycle parity).
--   * ingestion_admin_logs      â€” NEW. Partitioned (monthly RANGE) admin/audit
--                                 log sink written by the worker tier's
--                                 AdminLogger for immediate operator queries.
--   * ingestion_queue_snapshot  â€” richer per (queue, job_type, state,
...
-- ============================================================================
-- 2) INGESTION_JOBS â€” the live work queue (v2)
-- ============================================================================
BEGIN;
...
-- ============================================================================
-- 3) INGESTION_DEAD_LETTER_JOBS â€” terminal failures (v2)
-- ============================================================================
BEGIN;
...
-- ============================================================================
-- 4) INGESTION_ADMIN_LOGS â€” partitioned admin/audit log sink (NEW)
-- ----------------------------------------------------------------------------
...
-- ============================================================================
-- 5) INGESTION_QUEUE_SNAPSHOT â€” richer operator view (v2)
-- ============================================================================
BEGIN;
