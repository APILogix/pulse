CREATE TABLE projects (
    ...
    default_environment project_environment
...
CREATE INDEX idx_projects_cursor
...
CREATE INDEX idx_api_keys_expiry
...
-- idx_project_members_user already exists but isn't composite
CREATE INDEX IF NOT EXISTS idx_project_members_user_project
ON project_members(user_id, project_id);
-- Hot path: "latest release for project X in production"
