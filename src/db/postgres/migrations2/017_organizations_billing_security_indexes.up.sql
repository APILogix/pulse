...
-- ----------------------------------------------------------------------------
-- Enterprise hardening for organization security and billing-adjacent tables.
-- ============================================================================
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_org_api_keys_hash
  ON organization_api_keys(hashed_key);
