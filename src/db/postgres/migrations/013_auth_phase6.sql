-- Phase 6 auth: linked OAuth identities (Google/GitHub/Microsoft account linking).
...
COMMENT ON TABLE user_linked_identities IS
  'OAuth/OIDC social identities linked to an existing user account (not org SSO).';
