...
import {
  CreateProjectAlertRouteBodySchema,
  UpdateProjectAlertRouteBodySchema,
  ToggleProjectAlertRouteBodySchema,
  ListProjectAlertRoutesQuerySchema,
...
export async function projectAlertRoutes(fastify: FastifyInstance): Promise<void> {
