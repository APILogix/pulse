...
// EMAIL HELPERS
// ============================================================================
export function getBaseUrl(value, fallback) {
...
export function buildMfaDisableConfirmUrl(token) {
...
export async function sendMFAStatusEmail(user, enabled) {
    try {
        await authEmail.send({
            to: user.email,
            ...mfaStatusTemplate({
...
export async function sendMfaDisableConfirmEmail(user, token) {
    try {
        await authEmail.send({
            to: user.email,
 ...
 */
export async function generateEmailMfaOtp() {
...
export function hashEmailMfaOtp(code) {
 ...
 */
export async function createEmailMfaOtp(userId, deviceId, codeHash) {
 ...
 */
export async function consumeEmailMfaOtp(deviceId, codeHash) {
    return repository.consumeEmailMfaOtp(deviceId, codeHash);
}
export async function sendEmailMfaOtpEmail(user, code, deviceName, purpose) {
    try {
        await authEmail.send({
            to: user.email,
            ...mfaCodeTemplate({
