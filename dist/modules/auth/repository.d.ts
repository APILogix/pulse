...
export declare function findEmailVerificationByToken(tokenHash: string, client?: PoolClient): Promise<EmailVerificationRecord | null>;
export declare function findEmailVerificationByTokenHash(tokenHash: string, client?: PoolClient): Promise<EmailVerificationRecord | null>;
export declare function consumeEmailVerificationToken(tokenHash: string, client?: PoolClient): Promise<EmailVerificationRecord | null>;
