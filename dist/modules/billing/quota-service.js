...
import { checkLimitExceeded, projectUsage, addDays, daysBetween, createBillingLogger, BillingError, BillingErrorCodes } from './utils.js';
...
export class QuotaService {
    ...
    async checkQuota(orgId, metricType, requestedAmount = 1) {
    ...
    getLimitFromPlan(limits, metricType) {
