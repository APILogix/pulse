...
export declare class NoopAlertAnalysisHook implements AlertAnalysisHook {
    analyze(): Promise<AlertAnalysisResult | null>;
}
/** The currently registered analysis hook (NoopAlertAnalysisHook by default). */
export declare function getAlertAnalysisHook(): AlertAnalysisHook;
/** Register the AI analysis provider. Pass null to reset to the no-op hook. */
export declare function setAlertAnalysisHook(hook: AlertAnalysisHook | null): void;
//# sourceMappingURL=alert-analysis.d.ts.map