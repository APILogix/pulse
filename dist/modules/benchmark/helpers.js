 ...
 */
export function runHashing(iterations) {
 ...
 */
export function runSorting(size) {
    const start = performance.now();
 ...
 */
export function simulateAsyncTask(name, delayMs) {
 ...
 */
export function simulateJsonProcessing(records) {
    return new Promise((resolve) => {
        const start = performance.now();
