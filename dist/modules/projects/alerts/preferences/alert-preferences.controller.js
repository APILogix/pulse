...
import { UpdateAlertPreferenceBodySchema, } from "./alert-preferences.types.js";
...
export async function projectAlertPreferencesRoutes(fastify) {
    ...
    fastify.patch("/:prefId", { preHandler: [authenticate] }, async (request, reply) => {
...
//# sourceMappingURL=alert-preferences.controller.js.map