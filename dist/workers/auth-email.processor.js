 ...
 */
async function pollAuthEmailOutbox() {
    if (!isRunning)
        return;
    try {
 ...
 */
export async function startAuthEmailWorker() {
    if (isRunning)
        return;
    isRunning = true;
 ...
 */
export function stopAuthEmailWorker() {
    if (!isRunning)
        return;
    isRunning = false;
    if (timeoutId) {
...
//# sourceMappingURL=auth-email.processor.js.map