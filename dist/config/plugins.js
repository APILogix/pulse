...
async function healthPlugin(fastify) {
    ...
    fastify.get('/ready', async (_request, reply) => {
        ...
        try {
            ...
            checks.database = { healthy: false, latencyMs: Date.now() - dbStart, error: err.message };
        }
        ...
        try {
            ...
            checks.redis = { healthy: false, latencyMs: Date.now() - redisStart, error: err.message };
        }
        ...
        try {
            ...
            checks.logDatabase = { healthy: false, latencyMs: Date.now() - logDbStart, error: err.message };
        }
